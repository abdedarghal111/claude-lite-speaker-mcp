...
export const INPUT =
    "w-full rounded-lg border border-line bg-white px-2.5 py-2 text-xs text-text focus:outline-2 focus:outline-red focus:-outline-offset-1 disabled:cursor-default disabled:bg-bg disabled:opacity-55"
